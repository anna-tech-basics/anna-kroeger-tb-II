...
def gymgirl_homepage(root):
    ...
    # opens map
    connect_button = tk.Button(root, text="Connect with GymGirls", font=("georgia",24),command=lambda: connect_with_gym_girls(root))
    connect_button.place(relx=0.16,rely=0.5)
